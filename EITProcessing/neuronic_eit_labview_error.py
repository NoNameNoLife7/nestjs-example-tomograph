    ...
    if p >= Nbuff - 1:
        ...
        if minima:
            if min_average is None:
                ...
                ref_frame = frames_buffer[
                    :, from_time_to_buffer_index(index_in_time(minima))
                ]
                new_ref = True
                print(
                    "Iteration:",
        ...
        if maxima:
            ...
            if (
                ...
                if last_max_frame_index is None:
                    ...
                    max_frame = frames_buffer[
                        from_time_to_buffer_index(index_in_time(maxima))
                    ]
                    new_max = True
...
def _test_real_data():
    ...
    for i in range(n):
        ...
        args = {"frame": frame, "rate": rate, "Nrow": 2, "Ncol": 2}
        ...
        if SHOW_IMAGE:
            ...
            elif max_frame is not None:
                ax2.scatter([-1], [np.mean(max_frame)], c="green")
            ...
            if last_max_frame_index is not None:
                ...
                if 0 < ref_index < Nbuff:
                    ...
                    ax2.scatter([-1], [np.mean(ref_frame)], c="red")
